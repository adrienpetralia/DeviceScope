...
# Benchmark
Explore and compare the performance of our method. First select a **Dataset**, a **Detection Metric**, to measure *if* an appliance is well detected in a given window, and a **Localization Metric**, to measure *when* the appliance is well localize.
"""
